...
describe('Employee e2e test', () => {
  ...
  describe('new Employee page', () => {
    ...
    it('should create an instance of Employee', () => {
      cy.get(`[data-cy="firstName"]`).type('Queenie');
      cy.get(`[data-cy="firstName"]`).should('have.value', 'Queenie');

      cy.get(`[data-cy="lastName"]`).type('Kessler');
      cy.get(`[data-cy="lastName"]`).should('have.value', 'Kessler');

      cy.get(`[data-cy="email"]`).type('Dangelo.Zboncak@gmail.com');
      cy.get(`[data-cy="email"]`).should('have.value', 'Dangelo.Zboncak@gmail.com');

      cy.get(`[data-cy="phoneNumber"]`).type('trail');
      cy.get(`[data-cy="phoneNumber"]`).should('have.value', 'trail');

      cy.get(`[data-cy="hireDate"]`).type('2024-04-12T23:57');
      cy.get(`[data-cy="hireDate"]`).blur();
      cy.get(`[data-cy="hireDate"]`).should('have.value', '2024-04-12T23:57');

      cy.get(`[data-cy="salary"]`).type('29360');
      cy.get(`[data-cy="salary"]`).should('have.value', '29360');

      cy.get(`[data-cy="commissionPct"]`).type('4899');
      cy.get(`[data-cy="commissionPct"]`).should('have.value', '4899');
