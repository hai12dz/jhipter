...
describe('Task e2e test', () => {
  ...
  describe('new Task page', () => {
    ...
    it('should create an instance of Task', () => {
      cy.get(`[data-cy="title"]`).type('triumphantly');
      cy.get(`[data-cy="title"]`).should('have.value', 'triumphantly');

      cy.get(`[data-cy="description"]`).type('marvel outside');
      cy.get(`[data-cy="description"]`).should('have.value', 'marvel outside');
