...
describe('Department e2e test', () => {
  ...
  const departmentSample = { departmentName: 'luminous glaring overpower' };
  ...
  describe('new Department page', () => {
    ...
    it('should create an instance of Department', () => {
      cy.get(`[data-cy="departmentName"]`).type('off');
      cy.get(`[data-cy="departmentName"]`).should('have.value', 'off');
