...
describe('Job e2e test', () => {
  ...
  describe('new Job page', () => {
    ...
    it('should create an instance of Job', () => {
      cy.get(`[data-cy="jobTitle"]`).type('Customer Research Consultant');
      cy.get(`[data-cy="jobTitle"]`).should('have.value', 'Customer Research Consultant');

      cy.get(`[data-cy="minSalary"]`).type('16592');
      cy.get(`[data-cy="minSalary"]`).should('have.value', '16592');

      cy.get(`[data-cy="maxSalary"]`).type('3117');
      cy.get(`[data-cy="maxSalary"]`).should('have.value', '3117');
