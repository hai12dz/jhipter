...
describe('Location e2e test', () => {
  ...
  describe('new Location page', () => {
    ...
    it('should create an instance of Location', () => {
      cy.get(`[data-cy="streetAddress"]`).type('vice box finally');
      cy.get(`[data-cy="streetAddress"]`).should('have.value', 'vice box finally');

      cy.get(`[data-cy="postalCode"]`).type('impure');
      cy.get(`[data-cy="postalCode"]`).should('have.value', 'impure');

      cy.get(`[data-cy="city"]`).type('Antoniettafurt');
      cy.get(`[data-cy="city"]`).should('have.value', 'Antoniettafurt');

      cy.get(`[data-cy="stateProvince"]`).type('daintily meter neatly');
      cy.get(`[data-cy="stateProvince"]`).should('have.value', 'daintily meter neatly');
