  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="myappApp.employee.home.createOrEditLabel" data-cy="EmployeeCreateUpdateHeading">
            <Translate contentKey="myappApp.employee.home.createOrEditLabel">Create or edit a Employee</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('myappApp.employee.firstName')}
              ...
              <ValidatedField
                label={translate('myappApp.employee.lastName')}
                id="employee-lastName"
                name="lastName"
                data-cy="lastName"
                type="text"
              />
              <ValidatedField label={translate('myappApp.employee.email')} id="employee-email" name="email" data-cy="email" type="text" />
              <ValidatedField
                label={translate('myappApp.employee.phoneNumber')}
              ...
              />
              <ValidatedField
                label={translate('myappApp.employee.hireDate')}
              ...
              />
              <ValidatedField
                label={translate('myappApp.employee.salary')}
                id="employee-salary"
                name="salary"
                data-cy="salary"
                type="text"
              />
              <ValidatedField
                label={translate('myappApp.employee.commissionPct')}
              ...
              <ValidatedField
                ...
                name="manager"
                data-cy="manager"
                label={translate('myappApp.employee.manager')}
                type="select"
              >
                <option value="" key="0" />
                {employees
              ...
              <ValidatedField
                ...
                name="department"
                data-cy="department"
                label={translate('myappApp.employee.department')}
                type="select"
              >
                <option value="" key="0" />
                {departments
