    ...
    <Row>
      <Col md="8">
        <h2 data-cy="locationDetailsHeading">
          <Translate contentKey="myappApp.location.detail.title">Location</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="city">
              <Translate contentKey="myappApp.location.city">City</Translate>
            </span>
          </dt>
          ...
          <dt>
            <Translate contentKey="myappApp.location.country">Country</Translate>
          </dt>
